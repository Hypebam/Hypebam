                ...
                <div data-sequence-stage="" className="sequence-sticky">
                    ...
                    <div className="sequence-lines">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 2000 691" fill="none" data-sequence-svg="" style={{ overflow: 'visible' }} className="sequence-line-svg is-first">
                            <path d="M205.05 580.27 L405.14 634.84 L389.98 569.66 L706.78 634.84 L74.69 110.38 L677.98 174.04 L432.42 201.33 L1267.62 468.11 L955.37 319.56 L1825.43 -10.5" stroke="currentColor" strokeWidth="45" strokeLinecap="round" strokeLinejoin="round" fill="none"></path>
                        </svg>
                        <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 2000 682" fill="none" data-sequence-svg="" style={{ overflow: 'visible' }} className="sequence-line-svg is-second">
                            <path d="M1713.26 -51.26 L1247.92 286.76 L1480.59 217.03 L1232.76 382.25 L1651.12 605.07 L976.59 650.55 L1134.23 588.4 L280.84 51.81 L417.26 192.78 L91.37 83.64" stroke="currentColor" strokeWidth="45" strokeLinecap="round" strokeLinejoin="round" fill="none"></path>
                        </svg>
